---
title: Adobe GenStudioでバリエーションを制作
description: AEM AssetsとAdobe Expressを使用して、メールやMetaのアセットのバリエーションを制作し、一貫性のあるマーケティング体験を実現する方法をご紹介します。
