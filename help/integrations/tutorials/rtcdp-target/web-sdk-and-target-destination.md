---
title: Real-Time CDPと [!DNL Target] をWeb SDKおよび [!DNL Target] 宛先と統合
description: Real-Time CDPと [!DNL Target] をWeb SDKおよび [!DNL Target] 宛先と統合する方法について説明します。
...
# Real-Time CDPと[!DNL Target]をWeb SDKおよび[!DNL Target]の宛先と統合
