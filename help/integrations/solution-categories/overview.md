...
この節は、ビジネスニーズを持つが、使用するAdobe アプリケーションとその統合方法が不明なユーザーを支援します。 最も一般的な統合設定の多くを、ソリューション（B2B マーケティング、コンテンツsupply chain、Data Insights と Activation など）別に整理したものです。

Adobe アプリケーションを設定する方法は、環境に応じて様々です。 この節の目的は、現状のままデプロイしたり、環境のニーズに合わせて変更したりできるガイダンスを提供することです。
...
<tr>
   <td>
      <a  href="./content-supply-chain.md"><img alt="コンテンツSupply chain" src="https://cdn.experienceleague.adobe.com/thumb/content-supply-chain.png?lang=ja"/></a>
      <div><strong><a href="./content-supply-chain.md"> コンテンツsupply chain</a></strong></div>
      <p>
        コンテンツの作成と配信の高速化
      </p> 
    </td>
